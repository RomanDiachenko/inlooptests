...
class OpenBrowser(unittest.TestCase):
    ...
    def my_tests(self):
        self.open_page()
        self.scroll_to_newsletter()
        self.click_in_first_newsletter()
        self.test_jump_to_page("/en/api/feedlandingapi/getnewslettertemplatebody?id=6708")
        # self.open_some_tab()
